...
import 'Pages/DashBoard/Screens.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        providers: [
          ...
          ChangeNotifierProvider(create: (_) => DashboardCtrls()),
          ChangeNotifierProvider(create: (_) => stdCtrl()),
          ChangeNotifierProvider(create: (_) => SubjectsCtrls()),
